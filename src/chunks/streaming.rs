...
use crate::{async_util::pipeline::PipelineQueue, chunks::ChunkPos, debugging::{DebugRenderStats, DebugSystemTimes}, lighting::LightSeed, world::WorldState};
...
pub fn mark_chunk_and_neighbors_for_light(
    ...
    mark_chunk_for_light(world, streaming, ChunkPos::new(chunk.x + 1, chunk.y, chunk.z));
    mark_chunk_for_light(world, streaming, ChunkPos::new(chunk.x - 1, chunk.y, chunk.z));
    mark_chunk_for_light(world, streaming, ChunkPos::new(chunk.x, chunk.y + 1, chunk.z));
    mark_chunk_for_light(world, streaming, ChunkPos::new(chunk.x, chunk.y - 1, chunk.z));
    mark_chunk_for_light(world, streaming, ChunkPos::new(chunk.x, chunk.y, chunk.z + 1));
    mark_chunk_for_light(world, streaming, ChunkPos::new(chunk.x, chunk.y, chunk.z - 1));
}
...
pub fn mark_chunk_and_neighbors_for_mesh(
    ...
    mark_chunk_for_mesh(&mut world, streaming, ChunkPos::new(chunk.x + 1, chunk.y, chunk.z));
    mark_chunk_for_mesh(&mut world, streaming, ChunkPos::new(chunk.x - 1, chunk.y, chunk.z));
    mark_chunk_for_mesh(&mut world, streaming, ChunkPos::new(chunk.x, chunk.y + 1, chunk.z));
    mark_chunk_for_mesh(&mut world, streaming, ChunkPos::new(chunk.x, chunk.y - 1, chunk.z));
    mark_chunk_for_mesh(&mut world, streaming, ChunkPos::new(chunk.x, chunk.y, chunk.z + 1));
    mark_chunk_for_mesh(&mut world, streaming, ChunkPos::new(chunk.x, chunk.y, chunk.z - 1));
}